    ...
    <footer data-publisher-section="footer" className="bg-tropical-green text-off-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 bg-mango rounded-full flex items-center justify-center">
                <span className="text-white font-display font-bold text-lg">FI</span>
              </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm font-body">
              <li>
                <Link
                  href="#"
                  className="text-off-white/80 hover:text-mango transition-colors"
                >
                  {dict.links.legal}
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 bg-off-white/10 hover:bg-mango rounded-full flex items-center justify-center transition-colors"
        ...
        <div className="border-t border-off-white/20 pt-8">
          <p className="text-off-white/60 text-sm font-body text-center">
            © {new Date().getFullYear()} Frozen Island. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
